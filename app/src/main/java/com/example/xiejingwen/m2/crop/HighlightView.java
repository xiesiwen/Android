...
class HighlightView {
    ...
    protected void draw(Canvas canvas) {
        ...
        if (!hasFocus()) {
            ...
            if (handleMode == HandleMode.Always || (handleMode == HandleMode.Changing
    ...
    private void drawOutsideFallback(Canvas canvas) {
        ...
        canvas.drawRect(0, drawRect.bottom, canvas.getWidth(), canvas.getHeight(),
                outsidePaint);
        canvas.drawRect(0, drawRect.top, drawRect.left, drawRect.bottom, outsidePaint);
        canvas.drawRect(drawRect.right, drawRect.top, canvas.getWidth(), drawRect.bottom,
                outsidePaint);
    }
    ...
    private void drawThirds(Canvas canvas) {
        ...
        canvas.drawLine(drawRect.left + xThird, drawRect.top, drawRect.left + xThird,
                drawRect.bottom, outlinePaint);
        ...
        canvas.drawLine(drawRect.left, drawRect.top + yThird * 2, drawRect.right,
                drawRect.top + yThird * 2, outlinePaint);
    }
